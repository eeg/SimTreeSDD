...
\sectionfont{\flushleft\bf\large}
\subsectionfont{\flushleft\bf\normalsize}
\subsubsectionfont{\flushleft\bf\em\normalsize}
...
\addcontentsline{toc}{subsection}{Procedural stuff}

\subsection*{Bugs and help}
\addcontentsline{toc}{subsection}{Bugs and help}
This code has been tested and used by me and others since 2006 (some of it even dates back to John Huelsenbeck's 2003 Phylogenetic class at UC San Diego), and as far as I know it works as it should.
But of course, any software may have bugs, so if you encounter an unexplainable crash or a result that seems incorrect, please let me know.
