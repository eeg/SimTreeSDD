...
% TODO
% table of contents
% check defaults against the code
% put GPL info in each source file
% decide whether to package TreeLike with this
% make an alias for SimTreeSDD, using the xspace package to take care of the spacing at the end of the word
